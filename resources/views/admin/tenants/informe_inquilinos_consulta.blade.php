...
@section('content')
    <div class="panel panel-default" style="background:#f7d7da;border:4px solid #563e7c">
    <h3 class="page-title" style="padding:20px">Informe Consolidado Propiedad: <b style="font-weight: 800">{{$propiedad->name}}</b></h3>
    </div>
    @can('property_create')
    <p>
    ...
    <div class="panel panel-default">
        ...
        <div class="col-md-10">
           ...
           <div class="col-md-3 form-group">
                    ...
                    <input type="hidden" name="cc_propietario" value="<?=$cc_propietario;?>" id="cc_propietario">
                    ...
                    @if (count($tenants) > 0)
                        ...
                        @if ($tenant->role_id!=1)
                            ...
                            @if(isset($tenant->subproperty->renta))
                              @if(isset($tenant->subproperty->cambio_canon->nuevo_canon))
                             <td field-key='renta'>{{number_format($tenant->subproperty->cambio_canon->nuevo_canon) }}
                            </td>
                            @else
