    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body table-responsive">
          ...
          <div class="row">
             ...
             <div class="col-md-3">
                 <a href=" {{ route('admin.tenants.informe_inquilinos_consulta_propietario',[$seguro->cedula]) }}" target="_blank">
                        ...
                        @foreach ($deducciones as $deduccion)
                          <tr data-entry-id="{{ $deduccion->id }}">
                             <td field-key='name'>${{number_format($deduccion->valor)}}<br/>
                              ...
                              <td field-key='name'>{{date('d/F/Y',strtotime($deduccion->fecha_deduccion))}}
